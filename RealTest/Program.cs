...
namespace RealTest
{
    internal class Program
    {
        ...
        private static void DownloadTest()
        {
            ...
            WaitUntil(() => repoMod.LocalMods[storageMod] == ModActionEnum.Update, TimeSpan.FromSeconds(5));
            ...
            WaitUntil(() => repoMod.LocalMods.TryGetValue(storageMod, out var action) && action == ModActionEnum.Use, TimeSpan.FromSeconds(10));
